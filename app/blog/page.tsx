        ...
        <div className="bg-black text-white min-h-screen px-8">
            <section className="mx-auto max-w-screen-sm px-5 py-12">
                <div className="space-y-6">
                    ...
                    <p className="text-white leading-relaxed">This will be a dedicated page for my background, interest, and other stuff I'm interested in. 
                        ...
                        and Cheat Engine allowed you to change certain memory to whatever you want. I haven't learned Assembly but the GUI for Cheat Engine look similiar so I understand
